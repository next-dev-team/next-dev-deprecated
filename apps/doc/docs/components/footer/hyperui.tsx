/**
 * full html source code from https://www.hyperui.dev/
 */
      ...
      <footer className="bg-gray-900">
        <div className="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8">
          <div className="lg:items-center lg:justify-between lg:flex">
            ...
            <p className="max-w-md mx-auto mt-4 leading-relaxed text-center text-gray-400 sm:ml-0 lg:mr-0 sm:text-left lg:mt-0">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Incidunt
              consequuntur amet culpa cum itaque neque.
            </p>
          </div>

          <div className="grid grid-cols-1 gap-8 pt-16 mt-16 border-t border-gray-800 md:grid-cols-4 lg:grid-cols-6">
            <div className="text-center sm:text-left">
              <p className="text-lg font-medium text-white">About Us</p>
            ...
            <div className="text-center sm:text-left md:col-span-4 lg:col-span-2">
              ...
              <div className="max-w-md mx-auto mt-8 sm:ml-0">
                <p className="leading-relaxed text-center text-gray-400 sm:text-left">
                ...
                <form className="mt-4">
                  <div className="flex flex-col gap-4 sm:flex-row lg:flex-col lg:items-start">
                    ...
                    <input
                      className="w-full px-6 py-3 text-white bg-gray-800 border-gray-700 rounded-full shadow-sm"
                      type="email"
                      placeholder="Enter your email"
                    />

                    <button
                      className="block px-8 py-3 font-medium text-white transition bg-indigo-500 rounded-full hover:bg-indigo-600"
                      type="submit"
                    >
                      Subscribe
                    </button>
          ...
          <div className="pt-6 mt-16 border-t border-gray-800 sm:justify-between sm:items-center sm:flex">
      ...
      <footer className="bg-white">
        <div className="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8">
          <div className="lg:items-center lg:justify-between lg:flex">
            ...
            <p className="max-w-md mx-auto mt-4 leading-relaxed text-center text-gray-500 sm:ml-0 lg:mr-0 sm:text-left lg:mt-0">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Incidunt
              consequuntur amet culpa cum itaque neque.
            </p>
          </div>

          <div className="grid grid-cols-1 gap-8 pt-16 mt-16 border-t border-gray-100 md:grid-cols-4 lg:grid-cols-6">
            <div className="text-center sm:text-left">
              <p className="text-lg font-medium text-gray-900">About Us</p>
            ...
            <div className="text-center sm:text-left md:col-span-4 lg:col-span-2">
              ...
              <div className="max-w-md mx-auto mt-8 sm:ml-0">
                <p className="leading-relaxed text-center text-gray-500 sm:text-left">
                  Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                  Earum id, iure consectetur et error hic!
                </p>
    ...
    render: (
      <footer className="bg-gray-100">
        <div className="relative max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8 lg:pt-24">
          <div className="absolute top-4 sm:top-6 lg:top-8 right-4 sm:right-6 lg:right-8">
            <a
              className="inline-block p-2 text-white transition bg-teal-600 rounded-full shadow sm:p-3 lg:p-4 hover:bg-teal-500"
              href="#MainContent"
            >
              <span className="sr-only">Back to top</span>
 ...
 */
  ...
  {
    title: 'Center with Social Links as Priority',
    render: (
      ...
      <footer className="text-white bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500">
        <div className="max-w-screen-xl px-4 pt-32 pb-12 mx-auto sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <a
              className="inline-block px-12 py-3 mt-8 text-sm font-medium border rounded-full border-white/25 hover:bg-white hover:text-red-500"
              href=""
            >
              Get Started
            </a>
